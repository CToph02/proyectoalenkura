...
class Eje(models.Model):
    ...
    asignatura = models.ForeignKey(
        Asignatura, on_delete=models.CASCADE, related_name="ejes"
    )
...
class Contenido(models.Model):
    ...
    eje = models.ForeignKey(Eje, on_delete=models.CASCADE, related_name="contenidos")
...
class Apoderado(DateTime):
    ...
    collage_level = models.CharField(
        max_length=20,
        choices=CollegeLevels.choices,
        default=CollegeLevels.BASICO_COMPLETO,
    )
...
class Estudiante(DateTime):
    ...
    curso = models.ForeignKey(
        Curso, on_delete=models.CASCADE, related_name="students", null=True, blank=True
    )
